...
// AccessToken https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/authen/access_token
func (s Sdk) AccessToken(code string) (*userAccessTokenResponse, error) {
	request := userAccessTokenRequest{
		GrantType: "authorization_code",
		Code:      code,
	}
	var response userAccessTokenResponse
	err := s.post("https://open.feishu.cn/open-apis/authen/v1/access_token", s.token, request, &response)
	if err != nil {
		return nil, err
	}
